...
The logical variables can be converted to numeric as value 0 or 1, and the mean can be calculated.

The character variables cannot be converted to numeric, and the mean cannot be calculated as well.
